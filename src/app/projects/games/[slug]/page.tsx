...
export default async function GameProjectPage({ params, searchParams }: SlugProps) {
    ...
    return (
        ...
        {project.gifMP4 && (
            <div className="relative overflow-hidden px-6 pt-15 lg:px-8 md:h-[60vh] lg:h-[80vh] xl:h-[90vh] ">
                {/* Background GIF */}
                <video
                    autoPlay
                    muted
                    loop
                    playsInline
                    className="absolute inset-0 z-0 h-full w-full m-auto object-cover"
                >
                    <source
                        src={project.gifMP4}
                        type="video/mp4"
